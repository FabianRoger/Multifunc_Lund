#'
#' @title Functions from Gamfeldt and Roger (2017, Nat Eco Evo)
#' 
#' @description A set of functions for simulating BEF relationships based on
#' random draws of species with different traits. Code is taken from the following
...
AverageFunction <- function(SPM, FUNC, method = "average", selfunc = "F 1", selfac = 1,
  ...
  # error handling
  if (!"matrix" %in% class(SPM) | is.numeric(SPM) != TRUE) {
